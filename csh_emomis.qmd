...
![](images/curvi-linear.svg){width="900"}
...
::: {.column width="30%"}
![](images/mediating-relationship.png){width="1000"}
:::
...
![](images/daily_emotions_complete_smooth.png){width="600"}
...
## Emotional response reflect emotions in post
...
Covariates: PO, word count, following/followers, time difference, emotions in post
:::
